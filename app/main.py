...
def main():
    ...
    bbox_2d_topic = make87.get_publisher(name="BOUNDING_BOX_2D", message_type=Box2DAxisAligned)
    ...
    def callback(message: ImageJPEG):
        ...
        for face in faces:
            header = make87.header_from_message(
                header_cls=Header, message=message, append_entity_path="face", set_current_time=True
            )
